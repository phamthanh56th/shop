            ...
            <div id="sequence" class="seq">
                <div class="seq-screen">
                    <ul class="seq-canvas">
                       ...
                       <!--  <li>
                            <div class="seq-model">
                                <img data-seq src="<?php //echo bloginfo('template_directory');?>/img/slider/2.jpg" alt="Wristwatch slide img" />
                            </div>
                            <div class="seq-title">
                                        ...
                                        <ul class="aa-product-catg">
                                            ...
                                            <li>
                                                <figure>
                                                    ...
                                                    <figcaption>
                                                        <h4 class="aa-product-title"><a href="<?php echo get_the_permalink(); ?>">Polo T-Shirt</a></h4>
